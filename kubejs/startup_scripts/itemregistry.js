...
sog.create('resonant_processor_assembly').maxStackSize(64).displayName('Resonant Processor Assembly').tooltip('§2UEV-Tier Circuit')
sog.create('resonant_processor_computer').maxStackSize(64).displayName('Resonant Processor Computer').tooltip('§2UEV-Tier Circuit')
...
sog.create('cosmic_processor_assembly').maxStackSize(64).displayName('Transcendent Processor Assembly').tooltip('§0MAX-Tier Circuit')
sog.create('cosmic_processor_computer').maxStackSize(64).displayName('Transcendent Processor Computer').tooltip('§0MAX-Tier Circuit')
sog.create('cosmic_processor_mainframe').maxStackSize(64).displayName('Transcendent Processor Mainframe').tooltip('§0MAX-Tier Circuit')
...
sog.create('dimensional_processor').maxStackSize(64).displayName('Dimensional Processor').tooltip('§f§lUXV-Tier Circuit').rarity('epic')
...
sog.create('dimensional_processor_computer').maxStackSize(64).displayName('Dimensional Processor Computer').tooltip('§f§lUXV-Tier Circuit').rarity('epic')
sog.create('dimensional_processor_mainframe').maxStackSize(64).displayName('Dimensional Processor Mainframe').tooltip('§f§lUXV-Tier Circuit').rarity('epic')
